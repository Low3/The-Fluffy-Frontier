...
/datum/event_container/mundane
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Toilet Clog",					/datum/event/toilet_clog,			0, 		list(ASSIGNMENT_JANITOR = 5), 1, 0, 10),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Drone Malfunction",				/datum/event/rogue_maint_drones/,	0,		list(ASSIGNMENT_ENGINEER = 5), 1, 0, 10),
...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta/no_overmap(EVENT_LEVEL_MODERATE, "Meteor Shower",				/datum/event/meteor_wave,				0,		list(ASSIGNMENT_ENGINEER = 5), 1, 0, 10),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Prison Break",							/datum/event/prison_break,				0,		list(ASSIGNMENT_SECURITY = 100)),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Radiation Storm",						/datum/event/radiation_storm, 			0,		list(ASSIGNMENT_MEDICAL = 5), 1, 0, 10),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Toilet Flooding",						/datum/event/toilet_clog/flood,			0, 		list(ASSIGNMENT_JANITOR = 5), 1, 0, 10),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Drone Uprising",						/datum/event/rogue_maint_drones/,		0,		list(ASSIGNMENT_ENGINEER = 5), 1, 0, 10)
	)
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Blob",							/datum/event/blob, 					0,	list(ASSIGNMENT_ENGINEER = 5), 1, 0, 10),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Containment Breach",				/datum/event/prison_break/station,	0,	list(ASSIGNMENT_ANY = 5), 1, 0, 10),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Drone Revolution",				/datum/event/rogue_maint_drones/,	0,	list(ASSIGNMENT_ENGINEER = 5), 1, 0, 10)
	)
