...
/obj/item/clothing/mask/plunger/equipped(var/M, var/slot)
	..()
	sprite_sheets[SPECIES_RESOMI] = (slot == slot_head ? 'frontier/icons/mob/species/resomi/onmob_head_resomi.dmi' : 'frontier/icons/mob/species/resomi/onmob_mask_resomi.dmi')
