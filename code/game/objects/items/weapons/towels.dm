...
/obj/item/weapon/towel/equipped(var/M, var/slot)
	..()
	sprite_sheets = list(SPECIES_RESOMI = (slot == slot_head ? 'frontier/icons/mob/species/resomi/onmob_head_resomi.dmi' : 'frontier/icons/mob/species/resomi/onmob_suit_resomi.dmi'))
