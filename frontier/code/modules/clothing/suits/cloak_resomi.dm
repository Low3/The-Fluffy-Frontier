...
/obj/item/clothing/suit/storage/toggle/Resomicoat
	 name = "small cloak"
	 icon = 'frontier/icons/obj/clothing/species/resomi/obj_suit_resomi.dmi'
...
/obj/item/clothing/suit/storage/resomicloak
	...
	icon = 'frontier/icons/obj/clothing/species/resomi/obj_suit_resomi.dmi'
	item_icons = list(slot_wear_suit_str = 'frontier/icons/obj/clothing/species/resomi/obj_suit_resomi.dmi')
