/obj/item/clothing/glasses/sunglasses/lenses
	...
	item_icons = list(slot_glasses_str = 'frontier/icons/mob/species/resomi/onmob_eyes_resomi.dmi')
	icon = 'frontier/icons/obj/clothing/species/resomi/obj_eyes_resomi.dmi'
